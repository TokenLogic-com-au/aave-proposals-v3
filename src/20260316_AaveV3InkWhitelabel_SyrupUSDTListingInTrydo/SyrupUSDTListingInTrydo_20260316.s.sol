...
/**
 * @dev Deploy Ink
 * deploy-command: make deploy-ledger contract=src/20260316_AaveV3InkWhitelabel_SyrupUSDTListingInTrydo/SyrupUSDTListingInTrydo_20260316.s.sol:DeployInk chain=ink
 * verify-command: FOUNDRY_PROFILE=deploy npx catapulta-verify -b broadcast/SyrupUSDTListingInTrydo_20260316.s.sol/57073/run-latest.json
 */
contract DeployInk is InkScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3InkWhitelabel_SyrupUSDTListingInTrydo_20260316).creationCode
    );
