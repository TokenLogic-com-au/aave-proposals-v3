...
/**
 * @dev Test for AaveV3Plasma_RemoteGSMLaunchXLayer_20260526
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260526_Multi_RemoteGSMLaunchXLayer/AaveV3Plasma_RemoteGSMLaunchXLayer_20260526.t.sol -vv
 */
contract AaveV3Plasma_RemoteGSMLaunchXLayer_20260526_Test is ProtocolV3TestBase {
  AaveV3Plasma_RemoteGSMLaunchXLayer_20260526 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('plasma'), 21132780);
    proposal = new AaveV3Plasma_RemoteGSMLaunchXLayer_20260526();
  }
