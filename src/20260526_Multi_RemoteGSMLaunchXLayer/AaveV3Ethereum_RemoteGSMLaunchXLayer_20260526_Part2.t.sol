...
/**
 * @dev Test for AaveV3Ethereum_RemoteGSMLaunchXLayer_20260526_Part2
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260526_Multi_RemoteGSMLaunchXLayer/AaveV3Ethereum_RemoteGSMLaunchXLayer_20260526_Part2.t.sol -vv
 */
contract AaveV3Ethereum_RemoteGSMLaunchXLayer_20260526_Part2_Test is ProtocolV3TestBase {
  AaveV3Ethereum_RemoteGSMLaunchXLayer_20260526_Part1 internal part1;
  AaveV3Ethereum_RemoteGSMLaunchXLayer_20260526_Part2 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 25080900);
    part1 = new AaveV3Ethereum_RemoteGSMLaunchXLayer_20260526_Part1();
    proposal = new AaveV3Ethereum_RemoteGSMLaunchXLayer_20260526_Part2();
  ...
  function test_defaultProposalExecution() public {
    ...
    vm.skip(
      proposal.DIRECT_FACILITATOR() == address(0) ||
        ...
        proposal.XLAYER_BRIDGE_DESTINATION() == address(0)
    );
    defaultTest(
      'AaveV3Ethereum_RemoteGSMLaunchXLayer_20260526_Part2',
      AaveV3Ethereum.POOL,
      address(proposal)
    );
  }
  ...
  function test_bridgeLimitRestore() public {
    ...
    // XLayer lane to (capacity = TEMP_BRIDGE_CAPACITY, rate = TEMP_BRIDGE_CAPACITY - 1)
