...
/**
 * @dev Test for AaveV3Arbitrum_RemoteGSMLaunchXLayer_20260526
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260526_Multi_RemoteGSMLaunchXLayer/AaveV3Arbitrum_RemoteGSMLaunchXLayer_20260526.t.sol -vv
 */
contract AaveV3Arbitrum_RemoteGSMLaunchXLayer_20260526_Test is ProtocolV3TestBase {
  AaveV3Arbitrum_RemoteGSMLaunchXLayer_20260526 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('arbitrum'), 462142700);
    proposal = new AaveV3Arbitrum_RemoteGSMLaunchXLayer_20260526();
  }
