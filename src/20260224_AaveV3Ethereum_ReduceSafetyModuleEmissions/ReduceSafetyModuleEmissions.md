...
This proposal reduces Safety Module emissions and adjusts parameters for stkAAVE and stkABPT, saving a combined 29,200 AAVE/year (~0.18% of total supply, ~$3.6M) while transitioning stkABPT toward sunset in favour of Protocol-Owned Liquidity.
...
**stkABPT**: With the Aave Finance Committee (AFC) receiving additional funding via [AIP 449](https://vote.onaave.com/proposal/?proposalId=449&ipfsHash=0xb0a156896cd0f4b24828145c34c36201d03241250aacc0c1c4e49174f427fff4), additional AAVE/wETH liquidity is to be deployed that allows stkABPT to be sunset, resulting in a cost savings of 14,600 AAVE/year. By replacing the inefficient full-range 80/20-weighted pool with concentrated liquidity, the Aave DAO can facilitate swaps more capital-efficiently. Umbrella rollout provides targeted, capital-efficient protocol protection, reducing the legacy need for stkABPT as a Safety Module mechanism.
...
| stkABPT | Cooldown Period | 20 Days | 0 Days |

stkABPT emissions and slashing are already at 0 on-chain.

Combined annual emission savings: **~14,600 AAVE (~0.09% of total supply)**.
