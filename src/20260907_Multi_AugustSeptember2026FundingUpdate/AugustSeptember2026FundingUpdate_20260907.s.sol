...
import {EthereumScript, MonadScript, PlasmaScript} from 'solidity-utils/contracts/utils/ScriptUtils.sol';
...
contract CreateProposal is EthereumScript {
  function run() external {
    ...
    }
    {
      ...
      payloads[1] = GovV3Helpers.buildMonadPayload(vm, actionsMonad);
    }
    {
      IPayloadsControllerCore.ExecutionAction[]
