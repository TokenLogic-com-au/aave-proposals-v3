 ...
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260325_Multi_IncreaseGHOGSMCapacityOnPlasma/AaveV3Plasma_IncreaseGHOGSMCapacityOnPlasma_20260325_Part1.t.sol -vv
 */
contract AaveV3Plasma_IncreaseGHOGSMCapacityOnPlasma_20260325_Test is ProtocolV3TestBase {
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Plasma_IncreaseGHOGSMCapacityOnPlasma_20260325_Part1',
      AaveV3Plasma.POOL,
      address(proposal)
    );
  }
