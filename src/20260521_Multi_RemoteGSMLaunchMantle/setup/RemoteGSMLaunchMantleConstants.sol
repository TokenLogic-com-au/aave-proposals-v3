...
library RemoteGSMLaunchMantleConstants {
  // TODO: define amount to bridge; temporary numbers taken from Arbitrum's proposal
  ...
  // GSM USDT0 (Mantle's canonical USDT)
  // TODO: check amount (should be <= bridged amount, can be changed by steward later)
  uint128 public constant GSM_USDT0_RESERVE_LIMIT = 15_000_000 ether;

  // TODO: refine amount (stata tokens have a rate with respect to underlying)
  uint128 public constant GSM_USDT0_INITIAL_EXPOSURE_CAP = 15_000_000e6; // 15M, 6 decimals
