...
/**
 * @dev Test for AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part1
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260521_Multi_RemoteGSMLaunchMantle/AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part1.t.sol -vv
 */
contract AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part1_Test is ProtocolV3TestBase {
  ...
  AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part1 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 25080900);
    proposal = new AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part1();
  }
  ...
  function test_defaultProposalExecution() public {
    defaultTest(
      'AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part1',
      AaveV3Ethereum.POOL,
      address(proposal)
    );
  }
  ...
  function test_bridgeLimit() public {
    ...
    assertEq(
      ...
      bridgeLimitBefore + RemoteGSMLaunchMantleConstants.TEMP_BRIDGE_CAPACITY,
