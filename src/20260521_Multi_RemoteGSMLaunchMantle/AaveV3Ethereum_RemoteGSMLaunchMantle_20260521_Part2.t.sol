...
/**
 * @dev Test for AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part2
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260521_Multi_RemoteGSMLaunchMantle/AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part2.t.sol -vv
 */
contract AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part2_Test is ProtocolV3TestBase {
  AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part1 internal part1;
  AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part2 internal proposal;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 25080900);
    part1 = new AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part1();
    proposal = new AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part2();
  ...
  function test_defaultProposalExecution() public {
    ...
    vm.skip(
      proposal.DIRECT_FACILITATOR() == address(0) ||
        proposal.CCIP_BRIDGE() == address(0) ||
        proposal.MANTLE_BRIDGE_DESTINATION() == address(0)
    );
    defaultTest(
      'AaveV3Ethereum_RemoteGSMLaunchMantle_20260521_Part2',
      AaveV3Ethereum.POOL,
      address(proposal)
    );
  }
  ...
  function test_bridgeLimitRestore() public {
    ...
    // Mantle lane to (capacity = TEMP_BRIDGE_CAPACITY, rate = TEMP_BRIDGE_CAPACITY - 1)
    ...
    ).getCurrentOutboundRateLimiterState(CCIPChainSelectors.MANTLE);
    ...
    bucket = IUpgradeableBurnMintTokenPool(GhoEthereum.GHO_CCIP_TOKEN_POOL)
      .getCurrentInboundRateLimiterState(CCIPChainSelectors.MANTLE);
  ...
  function test_bridge() public {
    ...
    assertEq(
      ...
      RemoteGSMLaunchMantleConstants.DIRECT_FACILITATOR_CAPACITY,
