...
1. Configure new Chainlink CCIP lanes between Monad and the chains where GHO is launched with a rate limit of 1,500 GHO capacity and 300 GHO per second rate.
